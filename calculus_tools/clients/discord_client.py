"""Calculus-Tools Discord Client — Service adapter for discord API."""
import logging, os
...
class DiscordClient:
    ...
    def __init__(self, api_key: str = None, **kwargs):
        self.api_key = api_key or os.environ.get("DISCORD_API_KEY", "")
        self.base_url = kwargs.get("base_url", "https://api.discord.com/v1")
