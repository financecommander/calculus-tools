"""GHG / Climate Consciousness Tool — Greenhouse-gas and climate intelligence.

Exposes carbon-cycle modelling, emissions analysis, climate prediction,
and planetary-boundary assessment as a CrewAI tool for the Calculus
Holdings ecosystem.  Data classes and engine logic ported from
``swarm/climate_consciousness.py`` in super-duper-spork.

No external API key required — works with synthetic / injected data.
"""
...
# ======================================================================
# Carbon-cycle modelling (ported from ClimateConsciousnessModeling)
# ======================================================================
...
def model_carbon_cycle(
    ...
    # Derive fluxes from input or use defaults
...
class GHGAnalysisInput(BaseModel):
    ...
    time_period: str = Field(
        "2025",
        description="Time period label (e.g. '2025', '2020-2030').",
    )
    scenario: str = Field(
        "net_zero_2050",
